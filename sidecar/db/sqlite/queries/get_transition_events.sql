...
WHERE (sqlc.narg('started_at') IS NULL OR transition_events.started_at >= sqlc.narg('started_at'))
  AND (sqlc.narg('ended_at') IS NULL OR transition_events.ended_at <= sqlc.narg('ended_at'))
