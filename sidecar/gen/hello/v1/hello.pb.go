...
const file_hello_v1_hello_proto_rawDesc = "" +
	...
	"\x0fHelloServiceOne\x12;\n" +
	"\bSayHello\x12\x16.hello.v1.HelloRequest\x1a\x17.hello.v1.HelloResponse2N\n" +
	"\x0fHelloServiceTwo\x12;\n" +
	"\bSayHello\x12\x16.hello.v1.HelloRequest\x1a\x17.hello.v1.HelloResponseB\x9c\x01\n" +
	"\fcom.hello.v1B\n" +
	"HelloProtoP\x01Z?github.com/skulpturenz/timeboxxing/sidecar/gen/hello/v1;hellov1\xa2\x02\x03HXX\xaa\x02\bHello.V1\xca\x02\bHello\\V1\xe2\x02\x14Hello\\V1\\GPBMetadata\xea\x02\tHello::V1b\x06proto3"
...
var file_hello_v1_hello_proto_depIdxs = []int32{
	0, // 0: hello.v1.HelloServiceOne.SayHello:input_type -> hello.v1.HelloRequest
	0, // 1: hello.v1.HelloServiceTwo.SayHello:input_type -> hello.v1.HelloRequest
	1, // 2: hello.v1.HelloServiceOne.SayHello:output_type -> hello.v1.HelloResponse
	1, // 3: hello.v1.HelloServiceTwo.SayHello:output_type -> hello.v1.HelloResponse
